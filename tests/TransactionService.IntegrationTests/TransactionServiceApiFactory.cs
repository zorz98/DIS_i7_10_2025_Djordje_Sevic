...
public sealed class TransactionServiceApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureAppConfiguration((_, config) =>
        {
            ...
            {
                ["ConnectionStrings:TransactionDb"] = _sqlContainer.GetConnectionString(),
